...
To use datasette, you'll need a Python installation and to install some extra packages. (There's a brief guide to installing packages in the Chapter on @sec-code-preliminaries.). Then, to install the datasette package run
