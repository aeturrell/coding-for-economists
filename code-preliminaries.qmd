# Preliminaries {#sec-code-preliminaries}
...
Try going to the @sec-code-basics chapter now, click on the rocketship symbol (🚀) and then select "Colab". When the Colab notebook opens, select the first code cell and hit shift + enter to run it.
:::
...
::: {.callout-note title="Running code in the terminal instead" collapse="true"}
...
::: {.callout-note title="Start interactive windows and terminals within your project directory" collapse="true"}
...
You can find out more about the terminal in the chapter on @sec-wrkflow-command-line.
...
Well done if you made this far: starting is the hardest bit. (If you want to tweak your Visual Studio Code setup even more, there's some tips at the end of @sec-code-further-advanced.)
