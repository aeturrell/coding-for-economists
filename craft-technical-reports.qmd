# Writing Technical Reports {#sec-craft-technical-reports}
...
@zinsser2006writing and @white1972elements are two excellent general resources on writing. Perhaps the first and most important tip is to read one or both of these and take on board their lessons.
...
This section covers how to easily write your technical reports while following all of the best practice detailed in the previous sections. Some of the content is similar to what is in @sec-quarto.
...
Quarto markdown files have a ".qmd" file extension and look a lot like markdown, or they can be written in a Jupyter Notebook. Vanilla markdown (with file extension ".md") is the subject of the chapter @sec-wrkflow-markdown, and if you haven't yet looked at that, you may want to have a quick skim before reading the rest of this chapter. Quarto markdown is a superset of the markdown syntax, the main difference being that quarto has executable code blocks in addition to the usual markdown features.
...
Next we hit the content, which uses the typical markdown syntax featured in @sec-wrkflow-markdown. In the template below are examples of some of the key features, including:
