# Writing Referee Reports {#sec-craft-referee}
...
- The data:
  ...
  - Does the author discuss issues that may affect the data, for example "dark data" [@hand2020dark] (see @sec-craft-writing-papers for more on the types of dark data)?
